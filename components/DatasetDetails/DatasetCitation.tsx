        ...
        return (
            <>
                ...
                <div className="w-full flex flex-row justify-start items-center space-x-16 text-primary-500">
                    ...
                    <CardItem title="Status" hide={shouldHideDOIStatus(props.currentDOI)}>
                        {props.currentDOI.state}
                    </CardItem>

                    <CardItem title="Navigate to next state" hide={shouldHideDOIStatusNavigation(props.currentDOI)}>
