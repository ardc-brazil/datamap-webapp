...
export default function FileDescriptor(props) {
            ...
            <div className="flex flex-col border border-primary-300 min-w-[448px] w-full">
                ...
                <div className="flex p-4 ">
                    <div className="w-full bg-primary-50">
                        <h6 className="font-semibold">{fileName(props.selectedFile)} <span className="text-primary-500 no-underline">(10 MB)</span></h6>
                    </div>
                    <div className="">
