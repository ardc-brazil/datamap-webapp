...
/**
 * Represents the way that a user can link a DOI to a dataset.
 */
export enum GetDatasetDetailsDOIResponseLink {
    /**
     * MANUAL means that a user set the identifier an any other information manually.
     * This DOI was not generated by Datamap.
     */
    MANUAL = "MANUAL",

    /**
     * AUTO means that a user request to the platform to generate a new DOI automatically.
     * This DOI was generated by Datamap ;)
     */
    AUTO = "AUTO",
}
